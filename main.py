...
def setup_logging():
    ...
    log.basicConfig(
        ...
        handlers=[
            # Log messages to a file named bot.log
...
def application_setup():
    ...
    app = FastAPI(docs_url="/msai-docs", swagger_ui_parameters={
                  "tryItOutEnabled": True}, title="MSAI ECG VISUALIZATION", lifespan=lifespan)
